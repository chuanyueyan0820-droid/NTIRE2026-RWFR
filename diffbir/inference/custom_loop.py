...
class CustomInferenceLoop(InferenceLoop):
    ...
    def __init__(self, args: Namespace) -> "InferenceLoop":
        ...
        if self.args.captioner != "none":
            ...
            print("Captioner is set to none, using dummy captioner.")
            # 返回一个固定字符串的函数，避免 'NoneType' object is not callable
            self.captioner = lambda x: "a high-quality facial photo"
